...
use SubdivisionBundle\Form\InstituteType;
...
class InstituteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SubdivisionBundle:Institute')->findAll();


        return $this->render('AdminBundle:Institute:index.html.twig', array(
            'entities' => $entities
        ));
    }
     ...
     * @Method("POST")
     * @Template("AdminBundle:Institute:new.html.twig")
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SubdivisionBundle:Institute')->find($id);
     ...
     * @Method("PUT")
     * @Template("AdminBundle:Institute:edit.html.twig")
     * @param Request $request
     * @param $id
     * @return array|\Symfony\Component\HttpFoundation\RedirectResponse
     */
