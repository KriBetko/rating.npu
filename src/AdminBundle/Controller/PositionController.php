...
use SubdivisionBundle\Entity\Position;
use SubdivisionBundle\Form\PositionType;
...
class PositionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SubdivisionBundle:Position')->findAll();
     ...
     * @Method("POST")
     * @Template("AdminBundle:Position:new.html.twig")
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SubdivisionBundle:Position')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdminBundle:Position:edit.html.twig")
     * @param Request $request
     * @param $id
     * @return array|\Symfony\Component\HttpFoundation\RedirectResponse
     */
