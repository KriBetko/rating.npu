...
use SubdivisionBundle\Form\CathedraType;
...
class CathedraController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SubdivisionBundle:Cathedra')->findAll();
     ...
     * @Method("POST")
     * @Template("AdminBundle:Cathedra:new.html.twig")
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SubdivisionBundle:Cathedra')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdminBundle:Cathedra:edit.html.twig")
     * @param Request $request
     * @param $id
     * @return array|\Symfony\Component\HttpFoundation\RedirectResponse
     */
